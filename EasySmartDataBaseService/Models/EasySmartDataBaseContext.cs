...
using EasySmartDataBaseService.Models.Mapping;
...
namespace EasySmartDataBaseService.Models
{
    public partial class EasySmartDataBaseContext : DbContext
    {
        ...
        public DbSet<DeviceTypeToDevice> DeviceTypeToDevices { get; set; }
        ...
        public DbSet<RoleToPower> RoleToPowers { get; set; }
        ...
        public DbSet<UserRolePowerView> UserRolePowerViews { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new DeviceTypeToDeviceMap());
            ...
            modelBuilder.Configurations.Add(new RoleToPowerMap());
            ...
            modelBuilder.Configurations.Add(new UserToRoleMap());
            ...
            modelBuilder.Configurations.Add(new UserRolePowerViewMap());
        }
    }
}
